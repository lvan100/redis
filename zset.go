...
//}
//
//func (c *orderedSetOps) ZAdd(ctx context.Context, key string, args ...any) *Int64Replier {
//	args = append([]any{"ZADD", key}, args...)
//	return toInt64(c.driver.Exec(ctx, args...)
//}
//
//func (c *orderedSetOps) ZCard(ctx context.Context, key string) *Int64Replier {
//	args := []any{"ZCARD", key}
//	return toInt64(c.driver.Exec(ctx, args...)
//}
//
//func (c *orderedSetOps) ZCount(ctx context.Context, key, min, max string) *Int64Replier {
...
//}
//
//func (c *orderedSetOps) ZLexCount(ctx context.Context, key, min, max string) *Int64Replier {
...
//}
//
//func (c *orderedSetOps) ZRandMember(ctx context.Context, key string) *StringReplier {
...
//}
//
//func (c *orderedSetOps) ZRank(ctx context.Context, key, member string) *Int64Replier {
//	args := []any{"ZRANK", key, member}
//	return toInt64(c.driver.Exec(ctx, args...)
//}
//
//func (c *orderedSetOps) ZRem(ctx context.Context, key string, members ...any) *Int64Replier {
//	args := []any{"ZREM", key}
//	for _, member := range members {
//		args = append(args, member)
//	}
...
//}
//
//func (c *orderedSetOps) ZRemRangeByLex(ctx context.Context, key, min, max string) *Int64Replier {
//	args := []any{"ZREMRANGEBYLEX", key, min, max}
//	return toInt64(c.driver.Exec(ctx, args...)
//}
//
//func (c *orderedSetOps) ZRemRangeByRank(ctx context.Context, key string, start, stop int64) *Int64Replier {
//	args := []any{"ZREMRANGEBYRANK", key, start, stop}
//	return toInt64(c.driver.Exec(ctx, args...)
//}
//
//func (c *orderedSetOps) ZRemRangeByScore(ctx context.Context, key, min, max string) *Int64Replier {
...
//}
//
//func (c *orderedSetOps) ZRevRank(ctx context.Context, key, member string) *Int64Replier {
...
//}
//
//func (c *orderedSetOps) ZUnionStore(ctx context.Context, dest string, args ...any) *Int64Replier {
